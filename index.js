console.log("Welcome to Bukhari Airlines");
...
/* title */
document.getElementById("titleLight").innerHTML = "Memoria";
setTimeout(() => { document.getElementById("titleLight").innerHTML = "Story" }, 3000);
setTimeout(() => { document.getElementById("titleLight").innerHTML = "Episode" }, 6000);
...
/*Welcome words */
var words = ['Hi! What do you think of our website?', 'Awesome, right?', 'Well, we welcome you with open arms here.', 'Make sure to find out more, okay?', 'Have a nice day! :)'],
    part,
    i = 0,
    offset = 0,
    len = words.length,
